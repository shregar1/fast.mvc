...
Run tests:
    pytest tests/test_example_item.py -v
    pytest tests/test_example_item.py::test_create_item -v
"""
...
class TestItemStats:
    ...
    def test_get_statistics(self, item_client, completed_items, pending_items, mock_auth):
        """Get item statistics."""
        with mock_auth:
