...
class OrderWorkflowService:
    ...
    This service is intentionally slim: it delegates to the configured
    workflow engine (Temporal/Prefect/Dagster) via IWorkflowEngine.
    """

    def __init__(self, engine: Optional[IWorkflowEngine] = None) -> None:
        self._engine = engine or build_workflow_engine()

    async def start_order_lifecycle(self, order_id: str, tenant_id: str, payload: Dict[str, Any]) -> Optional[str]:
